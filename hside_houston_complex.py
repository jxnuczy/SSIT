...
if __name__ == '__main__':
    ...
    houston_512_46_dir = '/home/lch/Czy/SERT-master/houston64_46.db/'
    houston_512_46 = LMDBDataset(houston_512_46_dir)

    target_transform = HSI2Tensor()
    train_dataset = ImageTransformDataset(houston_512_46, train_transform, target_transform)
    print('==> Preparing data..')

    """Test-Dev"""
    basefolder = '/home/lch/Czy/SERT-master/Houston/test'


    mat_datasets = [MatDataFromFolder(
        basefolder, size=1, fns=['merged_file.mat'])]
...
#######################################################################
    ...
    while engine.epoch < 260:
        ...
        engine.validate(mat_loaders[0], 'hou')
