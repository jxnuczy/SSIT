...
if __name__ == '__main__':
    ...
    train_dir = '/home/lch/Czy/SERT-master/dataset2/train_real/'
    ...
    basefolder = '/home/lch/Czy/SERT-master/dataset2/test_real/'
    ...
    while engine.epoch < 1000:
        ...
        if engine.epoch == 200:
            ...
            adjust_learning_rate(engine.optimizer, base_lr*0.2)
          
        if engine.epoch == 400:
            
            adjust_learning_rate(engine.optimizer, base_lr*0.2*0.2)

        if engine.epoch == 600:

            adjust_learning_rate(engine.optimizer, base_lr*0.2*0.2*0.2)

        if engine.epoch == 800:

            adjust_learning_rate(engine.optimizer, base_lr*0.2*0.2*0.2*0.2)
